...
class soap_transport_http extends nusoap_base {
	...
	*/
	...
	function Connect($connection_timeout=0,$response_timeout=30){
	  	...
	  	//       loaded), and until PHP5 stream_getWrappers is not available.
...
class wsdl extends nusoap_base { 
	// URL or filename of the roo t of this WSDL
    var $wsdl; 
    ...
    */
    function webDescription(){
		...
		<div class=content>
			...
			<div class=nav>
				<p>Visualizar o <a href="'.$PHP_SELF.'?wsdl">WSDL</a> do servi&ccedil;o.
				Clique no nome da operação para visualizar sua documenta&ccedil;&atilde;o.</p>';
				foreach($this->GetOperations() as $op => $data){
				    $b .= "<li><a href='#' onclick=\"popout();popup('$op')\">$op</a></li>";
				    // create hidden div
				    $b .= "<div id='$op' class='hidden'>
				    <a href='#' onclick='popout()'><font color='#ffffff'>Fechar</font></a><br><br>";
 ...
 * @subpackage WebServices
 * @author   Dietrich Ayala <dietrich@ganx4.com> 
 * @version  $Id: nusoap.php,v 1.94 2005/08/04 0 1:27:42 snichol Exp $
 * @access   public
 */
