<?php
/**
 * Classe de gerenciamento de arquivos zip
 *
 ...
 * @package Framework
 * @subpackage Files
 * @version 2.5 - 2006-09-21 15:10:00
 * @author Vincent Blavet <vincent@phpconcept.net>
 * @link http://www.phpconcept.net
 * @link http://www.diegobotelho.com.br
 * @copyright 2009 Vincent Blavet
 */
  ...
  // ----- File list separator
  // In version 1.x of Zip, the separator for file list is a space
  ...
  // ----- Error configuration
  // 0 : Zip Class integrated error handling
...
// --------------------------------------------------------------------------------
  ...
  */
  ...
  // Class : Zip
  // Description :
  //   Zip is the class that represent a Zip archive.
  ...
  // Function : Zip()
  // Description :
  //   Creates a Zip object and set the name of the associated Zip archive
  //   filename.
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, 'Zip::Zip', "zipname=$p_zipname");
  ...
  //   (see Zip::listContent() for list entry format)
  // --------------------------------------------------------------------------------
  function Create($p_filelist)
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, 'Zip::create', "filelist='$p_filelist', ...");
    $v_result=1;
    ...
    if ($v_size > 1) {
      ...
      // method.
        ...
        if ($v_size == 2) {
          ...
          Zip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER,
		                       "Invalid number / type of arguments");
          //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, Zip::errorCode(), Zip::errorInfo());
          return 0;
        }
      }
    }
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, 'Zip::add', "filelist='$p_filelist', ...");
    $v_result=1;
    ...
    // ----- Invalid variable type for $p_filelist
      ...
      Zip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Invalid variable type '".gettype($p_filelist)."' for p_filelist");
      //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, 0);
      return 0;
    }
  ...
  function listContent()
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, 'Zip::listContent', "");
    $v_result=1;
    ...
    {
      unset($p_list);
      //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, 0, Zip::errorInfo());
      return(0);
    }
  ...
  function Extract()
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::extract", "");
    $v_result=1;
...
//    $v_path = "./";
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::extractByIndex", "index='$p_index', ...");
    $v_result=1;
...
//    $v_path = "./";
  ...
  function Delete()
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::delete", "");
    $v_result=1;
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::deleteByIndex", "index='$p_index'");
  ...
  function properties()
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::properties", "");
    ...
    if (@is_file($this->zipname))
    {
      ...
      if (($this->zip_fd = @fopen($this->zipname, 'rb')) == 0)
      {
        ...
        // ----- Error log
        Zip::privErrorLog(PCLZIP_ERR_READ_OPEN_FAIL, 'Unable to open archive \''.$this->zipname.'\' in binary read mode');

        // ----- Return
        //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, Zip::errorCode(), 0);
        return 0;
      }
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::duplicate", "");
    $v_result = 1;

    // ----- Reset the error handler
    $this->privErrorReset();

    // ----- Look if the $p_archive is a Zip object
    if ((is_object($p_archive)) && (get_class($p_archive) == 'pclzip'))
    {
      //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 2, "The parameter is valid Zip object '".$p_archive->zipname."'");
    ...
    else if (is_string($p_archive))
    {
      ...
      if (!is_file($p_archive)) {
        // ----- Error log
        Zip::privErrorLog(PCLZIP_ERR_MISSING_FILE, "No file with filename '".$p_archive."'");
    ...
    {
      // ----- Error log
      Zip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Invalid variable type p_archive_to_add");
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::merge", "");
    $v_result = 1;
    ...
    // ----- Look if the $p_archive_to_add is a Zip object
    if ((is_object($p_archive_to_add)) && (get_class($p_archive_to_add) == 'pclzip'))
    {
      //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 3, "The parameter is valid Zip object");
    ...
    else if (is_string($p_archive_to_add))
    {
      ...
      $v_object_archive = new Zip($p_archive_to_add);
...
// --------------------------------------------------------------------------------
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privCheckFormat", "");
    $v_result = true;
    ...
    if (!is_file($this->zipname)) {
      // ----- Error log
      Zip::privErrorLog(PCLZIP_ERR_MISSING_FILE, "Missing archive file '".$this->zipname."'");
      //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, false, Zip::errorInfo());
      return(false);
    }
    ...
    if (!is_readable($this->zipname)) {
      // ----- Error log
      Zip::privErrorLog(PCLZIP_ERR_READ_OPEN_FAIL, "Unable to read archive '".$this->zipname."'");
      //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, false, Zip::errorInfo());
      return(false);
    }
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privParseOptions", "");
    $v_result=1;
    
    // ----- Read the options
    $i=0;
    while ($i<$p_size) {
      //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 4, "Looking for table index $i, option = '".ZipUtilOptionText($p_options_list[$i])."(".$p_options_list[$i].")'");
      ...
      switch ($p_options_list[$i]) {
        ...
        case PCLZIP_OPT_ADD_PATH :
          ...
          if (($i+1) >= $p_size) {
            // ----- Error log
            Zip::privErrorLog(PCLZIP_ERR_MISSING_OPTION_VALUE, "Missing parameter value for option '".ZipUtilOptionText($p_options_list[$i])."'");
          ...
          // ----- Get the value
          $v_result_list[$p_options_list[$i]] = ZipUtilTranslateWinPath($p_options_list[$i+1], false);
          //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 2, "".ZipUtilOptionText($p_options_list[$i])." = '".$v_result_list[$p_options_list[$i]]."'");
          $i++;
        break;
        ...
        case PCLZIP_OPT_EXTRACT_DIR_RESTRICTION :
          ...
          if (   is_string($p_options_list[$i+1])
            ...
            //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 2, "".ZipUtilOptionText($p_options_list[$i])." set with an empty value is ignored.");
          }
        break;
        ...
        case PCLZIP_OPT_BY_NAME :
          ...
          if (is_string($p_options_list[$i+1])) {
            ...
            // ----- Error log
            Zip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE, "Wrong parameter value for option '".ZipUtilOptionText($p_options_list[$i])."'");
        ...
        case PCLZIP_OPT_PREPEND_COMMENT :
          ...
          if (($i+1) >= $p_size) {
            // ----- Error log
            Zip::privErrorLog(PCLZIP_ERR_MISSING_OPTION_VALUE,
			                     "Missing parameter value for option '"
								 .ZipUtilOptionText($p_options_list[$i])
								 ."'");
          ...
          if (is_string($p_options_list[$i+1])) {
            ...
            // ----- Error log
            Zip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE,
        ...
        case PCLZIP_OPT_BY_INDEX :
          ...
          if (is_string($p_options_list[$i+1])) {
            ...
            // ----- Error log
            Zip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE, "Value must be integer, string or array for option '".ZipUtilOptionText($p_options_list[$i])."'");
          ...
          for ($j=0; $j<sizeof($v_work_list); $j++) {
              ...
              elseif ($v_size_item_list == 2) {
                  ...
                  // ----- Error log
                  Zip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE, "Too many values in index range for option '".ZipUtilOptionText($p_options_list[$i])."'");
              ...
              if ($v_result_list[$p_options_list[$i]][$j]['start'] < $v_sort_value) {
                  ...
                  // ----- Error log
                  Zip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE, "Invalid order of index range for option '".ZipUtilOptionText($p_options_list[$i])."'");
        ...
        */
          ...
          //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 2, "call-back ".ZipUtilOptionText($p_options_list[$i])." = '".$v_function_name."'");

          // ----- Check that the value is a valid existing function
          if (!function_exists($v_function_name)) {
            // ----- Error log
            Zip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE, "Function '".$v_function_name."()' is not an existing function for option '".ZipUtilOptionText($p_options_list[$i])."'");
    ...
    if ($v_requested_options !== false) {
      for ($key=reset($v_requested_options); $key=key($v_requested_options); $key=next($v_requested_options)) {
        ...
        if ($v_requested_options[$key] == 'mandatory') {
          //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 4, "Detect a mandatory option : ".ZipUtilOptionText($key)."(".$key.")");
          // ----- Look if present
          if (!isset($v_result_list[$key])) {
            // ----- Error log
            Zip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Missing mandatory parameter ".ZipUtilOptionText($key)."(".$key.")");
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privFileDescrParseAtt", "");
    $v_result=1;
    ...
    foreach ($p_file_list as $v_key => $v_value) {
      ...
      if (!isset($v_requested_options[$v_key])) {
        // ----- Error log
        Zip::privErrorLog(PCLZIP_ERR_INVALID_PARAMETER, "Invalid file attribute '".$v_key."' for this file");
      ...
      switch ($v_key) {
        case PCLZIP_ATT_FILE_NAME :
          if (!is_string($v_value)) {
            Zip::privErrorLog(PCLZIP_ERR_INVALID_ATTRIBUTE_VALUE, "Invalid type ".gettype($v_value).". String expected for attribute '".ZipUtilOptionText($v_key)."'");
            //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, Zip::errorCode(), Zip::errorInfo());
            return Zip::errorCode();
          }

          $p_filedescr['filename'] = ZipUtilPathReduction($v_value);
          //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 2, "".ZipUtilOptionText($v_key)." = '".$v_value."'");
          
          if ($p_filedescr['filename'] == '') {
            Zip::privErrorLog(PCLZIP_ERR_INVALID_ATTRIBUTE_VALUE, "Invalid empty filename for attribute '".ZipUtilOptionText($v_key)."'");
            //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, Zip::errorCode(), Zip::errorInfo());
            return Zip::errorCode();
          }
        ...
        case PCLZIP_ATT_FILE_NEW_SHORT_NAME :
          ...
          $p_filedescr['new_short_name'] = ZipUtilPathReduction($v_value);
          //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 2, "".ZipUtilOptionText($v_key)." = '".$v_value."'");

          if ($p_filedescr['new_short_name'] == '') {
            Zip::privErrorLog(PCLZIP_ERR_INVALID_ATTRIBUTE_VALUE, "Invalid empty short filename for attribute '".ZipUtilOptionText($v_key)."'");
            //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, Zip::errorCode(), Zip::errorInfo());
            return Zip::errorCode();
          }
        break;
        ...
        case PCLZIP_ATT_FILE_NEW_FULL_NAME :
          ...
          $p_filedescr['new_full_name'] = ZipUtilPathReduction($v_value);
          //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 2, "".ZipUtilOptionText($v_key)." = '".$v_value."'");

          if ($p_filedescr['new_full_name'] == '') {
            Zip::privErrorLog(PCLZIP_ERR_INVALID_ATTRIBUTE_VALUE, "Invalid empty full filename for attribute '".ZipUtilOptionText($v_key)."'");
            //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, Zip::errorCode(), Zip::errorInfo());
            return Zip::errorCode();
          }
        break;
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privFileDescrExpand", "");
    $v_result=1;
    ...
    for ($i=0; $i<sizeof($p_filedescr_list); $i++) {
      ...
      $v_descr['filename'] = ZipUtilTranslateWinPath($v_descr['filename']);
      $v_descr['filename'] = ZipUtilPathReduction($v_descr['filename']);
      ...
      if (!file_exists($v_descr['filename'])) {
        ...
        Zip::privErrorLog(PCLZIP_ERR_MISSING_FILE, "File '".$v_descr['filename']."' does not exists");
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privCreate", "list");
    $v_result=1;
    $v_list_detail = array();
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privAdd", "list");
    $v_result=1;
    $v_list_detail = array();
    ...
    if (($v_zip_temp_fd = @fopen($v_zip_temp_name, 'wb')) == 0)
    {
      ...
      Zip::privErrorLog(PCLZIP_ERR_READ_OPEN_FAIL, 'Unable to open temporary file \''.$v_zip_temp_name.'\' in binary write mode');
    ...
    ZipUtilRename($v_zip_temp_name, $this->zipname);
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privOpenFd", 'mode='.$p_mode);
    $v_result=1;
  ...
  function privCloseFd()
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privCloseFd", "");
    $v_result=1;
...
//  function privAddList($p_list, &$p_result_list, $p_add_dir, $p_remove_dir, $p_remove_all_dir, &$p_options)
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privAddList", "list");
    $v_result=1;
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privAddFileList", "filedescr_list");
    $v_result=1;
    $v_header = array();
    ...
    for ($j=0; ($j<sizeof($p_filedescr_list)) && ($v_result==1); $j++) {
      ...
      = ZipUtilTranslateWinPath($p_filedescr_list[$j]['filename'], false);
      ...
      if (!file_exists($p_filedescr_list[$j]['filename'])) {
        ...
        Zip::privErrorLog(PCLZIP_ERR_MISSING_FILE, "File '".$p_filedescr_list[$j]['filename']."' does not exists");
        //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, Zip::errorCode(), Zip::errorInfo());
        return Zip::errorCode();
      }
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privAddFile", "filename='".$p_filedescr['filename']."'");
    $v_result=1;
...
//    $p_header['external'] = (is_file($p_filename)?0xFE49FFE0:0x41FF0010);
    ...
    if (isset($p_options[PCLZIP_CB_PRE_ADD])) {
      ...
      if ($p_header['stored_filename'] != $v_local_header['stored_filename']) {
        $p_header['stored_filename'] = ZipUtilPathReduction($v_local_header['stored_filename']);
    ...
    if ($p_header['status'] == 'ok') {
      ...
      if (is_file($p_filename))
      {
        ...
        if ((isset($p_options[PCLZIP_OPT_CRYPT]))
	      ...
	      $v_content_compressed = ZipUtilZipEncrypt($v_content_compressed,
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privCalculateStoredFilename", "filename='".$p_filedescr['filename']."'");
    $v_result=1;
    ...
    // ----- Look for path and/or short name change
      ...
      // ----- Look for partial path remove
        ...
        $v_compare = ZipUtilPathInclusion($p_remove_dir,
                                             $v_stored_filename);
        if ($v_compare > 0) {
          if ($v_compare == 2) {
            $v_stored_filename = "";
    ...
    $v_stored_filename = ZipUtilPathReduction($v_stored_filename);
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privWriteFileHeader", 'file="'.$p_header['filename'].'", stored as "'.$p_header['stored_filename'].'"');
    $v_result=1;
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privWriteCentralFileHeader", 'file="'.$p_header['filename'].'", stored as "'.$p_header['stored_filename'].'"');
    $v_result=1;
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privWriteCentralHeader", 'nb_entries='.$p_nb_entries.', size='.$p_size.', offset='.$p_offset.', comment="'.$p_comment.'"');
    $v_result=1;
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privList", "list");
    $v_result=1;
    ...
    if (@fseek($this->zip_fd, $v_central_dir['offset']))
    {
      ...
      // ----- Error log
      Zip::privErrorLog(PCLZIP_ERR_INVALID_ARCHIVE_ZIP, 'Invalid archive size');
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privConvertHeader2FileInfo", "Filename='".$p_header['filename']."'");
    $v_result=1;
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privExtractByRule", "path='$p_path', remove_path='$p_remove_path', remove_all_path='".($p_remove_all_path?'true':'false')."'");
    $v_result=1;
    ...
    for ($i=0, $v_nb_extracted=0; $i<$v_central_dir['entries']; $i++)
    {
	  ...
	  if (   ($v_extract)
          ...
          if (   (isset($p_options[PCLZIP_OPT_STOP_ON_ERROR]))
              ...
              Zip::privErrorLog(PCLZIP_ERR_UNSUPPORTED_COMPRESSION,
	  ...
	  if (($v_extract) && (($v_header['flag'] & 1) == 1)) {
          ...
          if (   (isset($p_options[PCLZIP_OPT_STOP_ON_ERROR]))
              ...
              Zip::privErrorLog(PCLZIP_ERR_UNSUPPORTED_ENCRYPTION,
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, 'Zip::privExtractFile', "path='$p_path', remove_path='$p_remove_path', remove_all_path='".($p_remove_all_path?'true':'false')."'");
    $v_result=1;
    ...
    else if ($p_remove_path != "")
    {
      ...
      if (ZipUtilPathInclusion($p_remove_path, $p_entry['filename']) == 2)
      {
    ...
    if (isset($p_options[PCLZIP_OPT_EXTRACT_DIR_RESTRICTION])) {
      ...
      $v_inclusion
      = ZipUtilPathInclusion($p_options[PCLZIP_OPT_EXTRACT_DIR_RESTRICTION],
                                $p_entry['filename']); 
      if ($v_inclusion == 0) {
        ...
        Zip::privErrorLog(PCLZIP_ERR_DIRECTORY_RESTRICTION,
    ...
    if (file_exists($p_entry['filename']))
    {
      ...
      if (is_dir($p_entry['filename']))
      {
        ...
        // ----- Look for PCLZIP_OPT_STOP_ON_ERROR
        // For historical reason first Zip implementation does not stop
        // when this kind of error occurs.
        if (   (isset($p_options[PCLZIP_OPT_STOP_ON_ERROR]))
		    && ($p_options[PCLZIP_OPT_STOP_ON_ERROR]===true)) {
            //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 2, "PCLZIP_OPT_STOP_ON_ERROR is selected, extraction will be stopped");

            Zip::privErrorLog(PCLZIP_ERR_ALREADY_A_DIRECTORY,
			                     "Filename '".$p_entry['filename']."' is "
      ...
      else if (!is_writeable($p_entry['filename']))
      {
        ...
        if (   (isset($p_options[PCLZIP_OPT_STOP_ON_ERROR]))
            ...
            Zip::privErrorLog(PCLZIP_ERR_WRITE_OPEN_FAIL,
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, 'Zip::privExtractFileInOutput', "");
    $v_result=1;
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, 'Zip::privExtractFileAsString', "p_entry['filename']='".$p_entry['filename']."'");
    $v_result=1;
...
//      if ($p_entry['compressed_size'] == $p_entry['size'])
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privReadFileHeader", "");
    $v_result=1;
    ...
    if ($v_data['id'] != 0x04034b50)
    {
      ...
      // ----- Error log
      Zip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, 'Invalid archive structure');
    ...
    if (strlen($v_binary_data) != 26)
    {
      ...
      // ----- Error log
      Zip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, "Invalid block size : ".strlen($v_binary_data));
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privReadCentralFileHeader", "");
    $v_result=1;
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privCheckFileHeaders", "");
    $v_result=1;
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privReadEndCentralDir", "");
    $v_result=1;
    ...
    {
      // ----- Error log
      Zip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, 'Unable to go to the end of the archive \''.$this->zipname.'\'');
    ...
    if ($v_size > 26) {
      ...
      {
        // ----- Error log
        Zip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, 'Unable to seek back to the middle of the archive \''.$this->zipname.'\'');
    ...
    if (!$v_found) {
      ...
      if ($v_pos == $v_size)
      {
        ...
        // ----- Error log
        Zip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, "Unable to find End of Central Dir Record signature");
    ...
    if (strlen($v_binary_data) != 18)
    {
      ...
      // ----- Error log
      Zip::privErrorLog(PCLZIP_ERR_BAD_FORMAT, "Invalid End of Central Dir Record size : ".strlen($v_binary_data));
    ...
    if (($v_pos + $v_data['comment_size'] + 18) != $v_size) {
	  ...
	  if (0) {
      // ----- Error log
      Zip::privErrorLog(PCLZIP_ERR_BAD_FORMAT,
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privDeleteByRule", "");
    $v_result=1;
    $v_list_detail = array();
    ...
    if ($v_nb_extracted > 0) {
        ...
        $v_temp_zip = new Zip($v_zip_temp_name);
        ...
        for ($i=0; $i<sizeof($v_header_list); $i++) {
            ...
            if (($v_result = ZipUtilCopyBlock($this->zip_fd, $v_temp_zip->zip_fd, $v_header_list[$i]['compressed_size'])) != 1) {
                // ----- Close the zip file
                $this->privCloseFd();
                $v_temp_zip->privCloseFd();
                @unlink($v_zip_temp_name);
  ...
  function privDirCheck($p_dir, $p_is_dir=false)
  {
    ...
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privDirCheck", "entry='$p_dir', is_dir='".($p_is_dir?"true":"false")."'");
    ...
    {
      // ----- Error log
      Zip::privErrorLog(PCLZIP_ERR_DIR_CREATE_FAIL, "Unable to create directory '$p_dir'");
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privMerge", "archive='".$p_archive_to_add->zipname."'");
    $v_result=1;
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "Zip::privDuplicate", "archive_filename='$p_archive_filename'");
    $v_result=1;
    ...
    if (($v_zip_temp_fd = @fopen($p_archive_filename, 'rb')) == 0)
    {
      ...
      Zip::privErrorLog(PCLZIP_ERR_READ_OPEN_FAIL, 'Unable to open archive file \''.$p_archive_filename.'\' in binary write mode');
  ...
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, 'Zip::privDecrypt', "size=".$p_size."");
    $v_result=1;
    
    // ----- To Be Modified ;-)
    $v_pwd = "test";
    
    $p_buffer = ZipUtilZipDecrypt($p_buffer, $p_size, $p_encryption_header,
	                                 $p_crc, $v_pwd);
  ...
  function privDisableMagicQuotes()
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, 'Zip::privDisableMagicQuotes', "");
    $v_result=1;
  ...
  function privSwapBackMagicQuotes()
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, 'Zip::privSwapBackMagicQuotes', "");
    $v_result=1;
  ...
  // --------------------------------------------------------------------------------
  // Function : ZipUtilPathReduction()
  // Description :
  // Parameters :
  // Return Values :
  // --------------------------------------------------------------------------------
  function ZipUtilPathReduction($p_dir)
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "ZipUtilPathReduction", "dir='$p_dir'");
    $v_result = "";
  ...
  // --------------------------------------------------------------------------------
  function ZipUtilPathInclusion($p_dir, $p_path)
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "ZipUtilPathInclusion", "dir='$p_dir', path='$p_path'");
    $v_result = 1;
    
    // ----- Look for path beginning by ./
    if (   ($p_dir == '.')
        || ((strlen($p_dir) >=2) && (substr($p_dir, 0, 2) == './'))) {
      $p_dir = ZipUtilTranslateWinPath(getcwd(), FALSE).'/'.substr($p_dir, 1);
      //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 5, "Replacing ./ by full path in p_dir '".$p_dir."'");
    }
    if (   ($p_path == '.')
        || ((strlen($p_path) >=2) && (substr($p_path, 0, 2) == './'))) {
      $p_path = ZipUtilTranslateWinPath(getcwd(), FALSE).'/'.substr($p_path, 1);
  ...
  // Return Values :
  // --------------------------------------------------------------------------------
  function ZipUtilCopyBlock($p_src, $p_dest, $p_size, $p_mode=0)
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "ZipUtilCopyBlock", "size=$p_size, mode=$p_mode");
    $v_result = 1;
  ...
  // --------------------------------------------------------------------------------
  function ZipUtilRename($p_src, $p_dest)
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "ZipUtilRename", "source=$p_src, destination=$p_dest");
    $v_result = 1;
  ...
  // --------------------------------------------------------------------------------
  function ZipUtilOptionText($p_option)
  {
    //--(MAGIC-PclTrace)--//PclTraceFctStart(__FILE__, __LINE__, "ZipUtilOptionText", "option='".$p_option."'");
  ...
  // --------------------------------------------------------------------------------
  // Function : ZipUtilTranslateWinPath()
  // Description :
  ...
  //   The path translated.
  // --------------------------------------------------------------------------------
  function ZipUtilTranslateWinPath($p_path, $p_remove_disk_letter=true)
  {
