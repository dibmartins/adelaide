...
class HTMLTableHeadException extends Exception{}
 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>
 * 
 * Classe de geração de tags thead em tabelas no formato html
 * @package Framework
 * @subpackage HTML
 * @version 1.0 - 2009-04-29 11:57:00
 * @author Diego Botelho Martins <dibmartins@yahoo.com.br>
...
class HTMLTableHead extends HTMLTablePart
{
    /** 
     * Attributes:
     */   
...
//------------------------------------------------------------------------------	
    ...
    */
     ...
     * @access public
     */
	public function Render($strTag = 'thead')
	{
