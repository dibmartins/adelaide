...
class ReportPointsGraph extends ReportGraph
{
   /**
    * Attributes:
    */
...
//---------------------------------------------------------------------------------------   
	...
	*/
	    ...
	    {	
			...
			// Setando o gráfico no formato de pontos
			$objPlot = new ScatterPlot(parent::GetData());
			$objPlot->mark->SetType(MARK_FILLEDCIRCLE); 
			$objPlot->mark->SetFillColor("red");
			$objPlot->mark->SetSize(10);
