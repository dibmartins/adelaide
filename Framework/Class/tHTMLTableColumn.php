...
class HTMLTableColumnException extends Exception{}
 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>
 * 
 * Classe de geração de colunas em tabelas no formato html
 * @package Framework 
 * @subpackage HTML
 * @version 1.0 - 2009-04-29 14:37:00
 * @author Diego Botelho Martins <dibmartins@yahoo.com.br>
...
//------------------------------------------------------------------------------	
    ...
    * Se o valor for uma string vazia preenche com espaço para
    * renderizar a coluna normalmente.
    * @return void		 
    * @access public
    */
