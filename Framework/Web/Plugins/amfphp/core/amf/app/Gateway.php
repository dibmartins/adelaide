...
class Gateway {
	...
	function service() {
		...
		{
			echo("<p>Gateway instalado corretamente. </p>");
			...
			echo /*"<p>Nota: If you're reading an " .
				 ...
				 "<a href='http://www.amfphp.org/docs' target='_blank'>Documenta&ccedil;&atilde;o AMF</p>" .
				 "<p><a href='browser' target='_blank'>AMF Browser</a></p>";
			echo "<pre>";
		}
	}
