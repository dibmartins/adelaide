<?php
	...
	// Pega o caminho at̩ a palavra "Framework":	
	$servicesPath = substr($_SERVER['SCRIPT_FILENAME'], 0, strrpos($_SERVER['SCRIPT_FILENAME'], 'Framework'));
	$voPath       = substr($_SERVER['SCRIPT_FILENAME'], 0, strrpos($_SERVER['SCRIPT_FILENAME'], 'Framework')).'vo/';
